...
$('.module-col-inr').hover(function () {
    $(this).addClass('hoverwidth');

    $('.module-col-inr').not(this).addClass('not-hover-width');
}, function () {
    $(this).removeClass('hoverwidth');
    $('.module-col-inr').removeClass('not-hover-width');
});